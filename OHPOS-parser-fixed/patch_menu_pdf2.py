...
content = content.replace("    PremiumModalOverlay(\n        isVisible = selectedItemForAction", overlays + "\n    PremiumModalOverlay(\n        isVisible = selectedItemForAction")
...
content = content.replace("    if (itemToDelete != null) {\n        androidx.compose.material3.AlertDialog(", fab_menu + "\n    if (itemToDelete != null) {\n        androidx.compose.material3.AlertDialog(")

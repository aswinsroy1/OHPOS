...
# Replace target and one extra closing brace at the end
text = text.replace(target, replacement)

# Because we added a wrapper `androidx.compose.ui.window.Dialog(...) {`, we need to add an extra `}` at the end of `PdfImportReviewOverlay`
